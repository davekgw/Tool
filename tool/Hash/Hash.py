...
Date: 07/07/2018
Team: Bravo Team
Facebook : https://mobile.facebook.com/ld.profile1000098661657117
'''
import os
import sys
import time
...
try:
	clearscreen()
	leethash_banner()
	print (R + "[" + Y + "#" + R + "]" + W + " Developer" + R + ": " + W + "Dave Koagow" + N)
	print (R + "[" + Y + "#" + R + "]" + W + " Date  " + R + ": " + W + "11/06/2019" + N)
	print (R + "[" + Y + "#" + R + "]" + W + " Team  " + R + ": " + W + "Bravo Team" + N)
	print (R + "[" + Y + "#" + R + "]" + W + " Facebook" + R + ": " + W + "www.facebook.com/id.profile" + N)
